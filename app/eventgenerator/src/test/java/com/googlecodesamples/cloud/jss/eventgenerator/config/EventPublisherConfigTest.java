...
public class EventPublisherConfigTest {
  ...
  private static final String EXPECTED_TOPIC_NAME = String.format("projects/%s/topics/test-event-topic", GOOGLE_CLOUD_PROJECT);
  ...
  private static final String WARN_MSG_GCP_PROJECT = "environment variable 'GOOGLE_CLOUD_PROJECT' has not been set, test skipped.";

  @Autowired
  private EventPublisherConfig config;
