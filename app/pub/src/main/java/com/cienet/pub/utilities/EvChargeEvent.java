 ...
 */
package com.cienet.pub.utilities;
...
public class EvChargeEvent extends org.apache.avro.specific.SpecificRecordBase
   ...
   *     this class
   */
  public static EvChargeEvent fromByteBuffer(java.nio.ByteBuffer b) throws java.io.IOException {
   ...
   */
  public EvChargeEvent(
      java.lang.CharSequence session_id,
      java.lang.Integer station_id,
      java.lang.CharSequence location,
      java.lang.CharSequence session_start_time,
      java.lang.CharSequence session_end_time,
      java.lang.Float avg_charge_rate_kw,
      java.lang.Float battery_capacity_kwh,
      java.lang.Float battery_level_start) {
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
      case 0:
        ...
        break;
      case 1:
        station_id = (java.lang.Integer) value$;
        break;
      case 2:
        location = (java.lang.CharSequence) value$;
        break;
      case 3:
        session_start_time = (java.lang.CharSequence) value$;
        break;
      case 4:
        session_end_time = (java.lang.CharSequence) value$;
        break;
      case 5:
        avg_charge_rate_kw = (java.lang.Float) value$;
        break;
      case 6:
        battery_capacity_kwh = (java.lang.Float) value$;
        break;
      case 7:
        battery_level_start = (java.lang.Float) value$;
        break;
      default:
        throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
   ...
   */
  public static com.cienet.pub.utilities.EvChargeEvent.Builder newBuilder() {
    return new com.cienet.pub.utilities.EvChargeEvent.Builder();
  }
   ...
   */
  public static com.cienet.pub.utilities.EvChargeEvent.Builder newBuilder(
      com.cienet.pub.utilities.EvChargeEvent.Builder other) {
    if (other == null) {
      return new com.cienet.pub.utilities.EvChargeEvent.Builder();
    } else {
      return new com.cienet.pub.utilities.EvChargeEvent.Builder(other);
    }
  }
   ...
   */
  public static com.cienet.pub.utilities.EvChargeEvent.Builder newBuilder(
      com.cienet.pub.utilities.EvChargeEvent other) {
    if (other == null) {
      return new com.cienet.pub.utilities.EvChargeEvent.Builder();
    } else {
      return new com.cienet.pub.utilities.EvChargeEvent.Builder(other);
  ...
  public static class Builder
      extends org.apache.avro.specific.SpecificRecordBuilderBase<EvChargeEvent>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.cienet.pub.utilities.EvChargeEvent.Builder other) {
      super(other);
      ...
      if (isValidValue(fields()[6], other.battery_capacity_kwh)) {
        this.battery_capacity_kwh =
            data().deepCopy(fields()[6].schema(), other.battery_capacity_kwh);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.cienet.pub.utilities.EvChargeEvent other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.session_id)) {
        this.session_id = data().deepCopy(fields()[0].schema(), other.session_id);
     ...
     * @return This builder.
     */
    public com.cienet.pub.utilities.EvChargeEvent.Builder setSessionId(
     ...
     * @return This builder.
     */
    public com.cienet.pub.utilities.EvChargeEvent.Builder clearSessionId() {
      session_id = null;
     ...
     * @return This builder.
     */
    public com.cienet.pub.utilities.EvChargeEvent.Builder setStationId(int value) {
     ...
     * @return This builder.
     */
    public com.cienet.pub.utilities.EvChargeEvent.Builder clearStationId() {
     ...
     * @return This builder.
     */
    public com.cienet.pub.utilities.EvChargeEvent.Builder setLocation(
        java.lang.CharSequence value) {
     ...
     * @return This builder.
     */
    public com.cienet.pub.utilities.EvChargeEvent.Builder clearLocation() {
      location = null;
     ...
     * @return This builder.
     */
    public com.cienet.pub.utilities.EvChargeEvent.Builder setSessionStartTime(
        java.lang.CharSequence value) {
     ...
     * @return This builder.
     */
    public com.cienet.pub.utilities.EvChargeEvent.Builder clearSessionStartTime() {
     ...
     * @return This builder.
     */
    public com.cienet.pub.utilities.EvChargeEvent.Builder setSessionEndTime(
        java.lang.CharSequence value) {
     ...
     * @return This builder.
     */
    public com.cienet.pub.utilities.EvChargeEvent.Builder clearSessionEndTime() {
     ...
     * @return This builder.
     */
    public com.cienet.pub.utilities.EvChargeEvent.Builder setAvgChargeRateKw(float value) {
     ...
     * @return This builder.
     */
    public com.cienet.pub.utilities.EvChargeEvent.Builder clearAvgChargeRateKw() {
     ...
     * @return This builder.
     */
    public com.cienet.pub.utilities.EvChargeEvent.Builder setBatteryCapacityKwh(float value) {
     ...
     * @return This builder.
     */
    public com.cienet.pub.utilities.EvChargeEvent.Builder clearBatteryCapacityKwh() {
     ...
     * @return This builder.
     */
    public com.cienet.pub.utilities.EvChargeEvent.Builder setBatteryLevelStart(float value) {
     ...
     * @return This builder.
     */
    public com.cienet.pub.utilities.EvChargeEvent.Builder clearBatteryLevelStart() {
    ...
    public EvChargeEvent build() {
      try {
        ...
        record.station_id =
            fieldSetFlags()[1] ? this.station_id : (java.lang.Integer) defaultValue(fields()[1]);
        record.location =
            fieldSetFlags()[2] ? this.location : (java.lang.CharSequence) defaultValue(fields()[2]);
        ...
        record.avg_charge_rate_kw =
            fieldSetFlags()[5]
                ? this.avg_charge_rate_kw
                : (java.lang.Float) defaultValue(fields()[5]);
        record.battery_capacity_kwh =
            fieldSetFlags()[6]
                ? this.battery_capacity_kwh
                : (java.lang.Float) defaultValue(fields()[6]);
        record.battery_level_start =
            fieldSetFlags()[7]
                ? this.battery_level_start
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<EvChargeEvent> WRITER$ =
      (org.apache.avro.io.DatumWriter<EvChargeEvent>) MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<EvChargeEvent> READER$ =
      (org.apache.avro.io.DatumReader<EvChargeEvent>) MODEL$.createDatumReader(SCHEMA$);
  ...
  public void customDecode(org.apache.avro.io.ResolvingDecoder in) throws java.io.IOException {
    ...
    if (fieldOrder == null) {
      this.session_id =
          in.readString(this.session_id instanceof Utf8 ? (Utf8) this.session_id : null);
      ...
      this.session_start_time =
          in.readString(
              this.session_start_time instanceof Utf8 ? (Utf8) this.session_start_time : null);

      this.session_end_time =
          in.readString(
              this.session_end_time instanceof Utf8 ? (Utf8) this.session_end_time : null);
      ...
      for (int i = 0; i < 8; i++) {
        switch (fieldOrder[i].pos()) {
          ...
          case 2:
            this.location =
                in.readString(this.location instanceof Utf8 ? (Utf8) this.location : null);
            break;

          case 3:
            this.session_start_time =
                in.readString(
                    this.session_start_time instanceof Utf8
                        ? (Utf8) this.session_start_time
                        : null);
            break;
